 ...
 *------------------------------------------------------------------------------
 * $Revision:   1.10  $
 * $Modtime:   Sep 08 2005 11:39:44  $
 * $Log:   //mtkvs01/vmdata/meta_app_dll/archives/Meta_App_Dll/Export/METAAPP.h-arc  $
 *
 * 07 26 2012 eason.lai
 * [STP100006032]  Add new METAAPP API(s) to support GPRS inter slot ramp table NVRAM/file options
 * .
 *
 * 07 05 2012 eason.lai
 * [STP100005874]  METAAPP pa control read/write nvram/file API(s)
 * .
 *
 * 06 12 2012 yh.sung
 * [STP100005805] [META_APP_DLL] Thread-safety review
 * .
 *
 * 10 09 2011 yh.sung
 * [STP100005138]  [META_DLL] Update build script (integrate Calibration library into META DLL workspace)
 * Reconciled offline work
 *  (Add new folders/files)
 *
 * 05 26 2011 bulin.huang
 * [STP100004712]  [META_APP_DLL]MT6251 ADC®Õ­ã metapp.dll±µ¤f??¡C
 * .
 *
 * 07 15 2010 shumin.chen
 * [STP100004053][META] Check in META APP DLL_v6.1028.0
 * New functions for NVRAM read/write and INI file read/write:
 * 1. WIFI MT5921 Crystal CAP ID and Thermal Sensor
 * 2. WCDMA MT6160 relevant features (TADC/AGC/APC)
 * 3. AFC Crystal 33 steps
 *
 * 04 19 2010 shumin.chen
 * [STP100103070][4N tool customer release verification] - 3G_Tools W1016
 * check in METAAPPDLL_v6.1012.02 for BT 6611,6612,6616,6636 (CAP ID, and BD address) .
 *
 * 03 22 2010 shumin.chen
 * [STP100003860][META] META_APP_DLL_v6.0952.0
 * .
 *
 * Jul 16 2008 mtk00490
 * [STP100001754] [META_APP_DLL] META_APP_DLL ver 5.0828.0
 *
 *
 * May 21 2008 mtk00490
 * [STP100001727] [META_APP_DLL] META_APP_DLL ver 5.0816.0
 *
 *
 * Dec 28 2007 mtk00490
 * [STP100001600] [META_APP_DLL]META_APP_DLL ver 5.0752.0
 *
 *
 * Sep 8 2007 mtk00490
 * [STP100001482] [META_APP_DLL] META_APP_DLL ver 5.5.0
 *
 *
 * Jul 24 2007 mtk00490
 * [STP100001482] [META_APP_DLL] META_APP_DLL ver 5.5.0
 *
 *
 * May 18 2007 mtk00490
 * [STP100001400] [META_APP_DLL] META_APP_DLL ver 5.3.8
 *
 *
 * Feb 6 2007 mtk00490
 * [STP100001306] [META_APP_DLL] META_APP_DLL ver 5.3.6.0
 *
 *
 * Dec 28 2006 mtk00490
 * [STP100001272] [META_APP_DLL] META_APP_DLL ver 5.3.4.1
 *
 *
 * Nov 15 2006 mtk00490
 * [STP100001220] [META_APP_DLL] META_APP_DLL ver 5.3.3.0
 *
 *
 * Oct 20 2006 mtk00490
 * [STP100001182] [META_APP_DLL] META_APP_DLL ver 5.3.2.0
 *
 *
 * Aug 21 2006 mtk00490
 * [STP100000799] [META_APP_DLL] META_APP_DLL ver 5.0.2
 *
 *
 *    Rev 1.10   Sep 08 2005 13:27:00   mtk00490
 * Support two APC DC offset
 * 1. METAAPP_Rf_QueryIfTwoApcDCOffsetSupport()
 * 2. METAAPP_readAPCfromNVRAM_Ex()
 * 3. METAAPP_writeAPCtoNVRAM_Ex()
 * 4. METAAPP_readAPCfromFile_Ex()
 * 5. METAAPP_WriteAPCtoFile_Ex()
 *
 *    Rev 1.9   Sep 08 2005 13:18:20   mtk00490
 * Support two APC DC offset
 * 1. METAAPP_Rf_QueryIfTwoApcDCOffsetSupport()
 * 2. METAAPP_readAPCfromNVRAM_Ex()
 * 3. METAAPP_writeAPCtoNVRAM_Ex()
 ...
 * 5. METAAPP_WriteAPCtoFile_Ex()
 *
 *    Rev 1.8   Aug 12 2005 14:09:48   mtk00490
 * Provide FAT related functions
 * ¡P   METAAPP_FAT_Open
 * ¡P   METAAPP_FAT_Close
 * ¡P   METAAPP_FAT_GetFileSize
 * ¡P   METAAPP_FAT_Read_To_File
 * ¡P   METAAPP_FAT_Write_By_File
 * ¡P   METAAPP_FAT_Delete
 * ¡P   METAAPP_FAT_Find_Start
 * ¡P   METAAPP_FAT_Find_Head
 * ¡P   METAAPP_FAT_Find_Prev
 * ¡P   METAAPP_FAT_Find_Next
 * ¡P   METAAPP_FAT_Find_GetFileInfo
 * ¡P   METAAPP_FAT_Find_Close
 *
 *    Rev 1.7   Apr 18 2005 11:59:16   mtk00490
 * Provide 1.   Crystal calibration functions¡P METAAPP_Rf_SetCrystalCapId()¡P  METAAPP_readCapIdfromNVRAM()¡P  METAAPP_writeCapIdtoNVRAM()¡P   METAAPP_ReadCapIdfromFile()¡P   METAAPP_WriteCapIdToFile()
 * 2.   Continuous sine wave AFC detection functions¡P  METAAPP_Rf_SetAfcSinWaveDetection()
 * 3.   Custom acoustic volume functions¡P  METAAPP_readCustAcstfromNVRAM()¡P   METAAPP_writeCustAcsttoNVRAM()¡P    METAAPP_readCustAcstfromFile()¡P    METAAPP_writeCustAcsttoFile()
 *
 *    Rev 1.6   Jan 30 2005 11:33:12   mtk00490
 * Add band mode setting functions
 * 1. METAAPP_readSettingBandfromNVRAM()
 * 2. METAAPP_writeSettingBandtoNVRAM()
 * 3. METAAPP_readSettingBandfromFile()
 * 4. METAAPP_WriteSettingBandtoFile()
 *
 *    Rev 1.5   Jan 24 2005 20:23:46   mtk00490
 * 1.   Provide BROM_DLL, META_DLL and METAAPP_DLL version functions.¡P
 *         METAAPP_GetMETADllVersion()¡P    METAAPP_GetMETAAPPDllVersion()¡P    METAAPP_GetBROMDllVersion()
 * 2.   Add  function for TX phase error calibration¡P  METAAPP_Rf_BBTXAutoCal ()               METAAPP_Rf_GetBBTxCfg2()
 *         METAAPP_Rf_SetBBTxCfg2()                 METAAPP_readTxIQfromNVRAM()             METAAPP_writeTxIQtoNVRAM()              METAAPP_readTxIQfromFile()              METAAPP_WriteTxIQtoFile()
 *
 *    Rev 1.4   Dec 31 2004 16:22:22   mtk00490
 * New feature
 * 1. DCS, PCS, GSM850 AFC calibration
 * 2. Get target version
 *
 *    Rev 1.3   Aug 28 2004 18:41:50   mtk00490
 * META APP dll ver 3.5.05
 *
 *    Rev 1.2   Jul 20 2004 13:25:24   mtk00490
 * META APP dll ver 3.5.04
 *
 *    Rev 1.1   Jun 23 2004 15:58:14   mtk00490
 * META APP dll ver 3.5.03
 *
 *    Rev 1.0   Jun 03 2004 11:10:54   mtk00490
 * Initial revision.
 * Resolution for 1: META APP dll ver 3.5.02
 *
 *------------------------------------------------------------------------------
