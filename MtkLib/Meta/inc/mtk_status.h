...
typedef enum {
    ...
    ,S_BROM_VCORE_ADJUSTMENT_FAIL              = 2048 /*!<(2048) */
    ,S_BROM_FAIL_TO_GET_BBCHIP_TINY_SYSTEM_INFO = 2049
...
// MT6276 SV5 Bootloader
    ...
    ,S_FT_MOUNT_FLASH_LAYOUT_FAIL = 4097
    ,S_FT_CLEAR_LONG_PRESS_PWKEY_FAIL = 4098    /*!<(4098) <B>[DLL Issue]</B> Failed to clear long press PWKEY setting*/
    ,S_FT_MOUNT_INVALID_FLASH_LAYOUT = 4099     /*!<(4099) <B>[User's Issue]</B> The flash layout is invalid*/
    ,S_FT_ENABLE_DA_LOGGING_CHANNEL_FAIL = 4100    /*!<(4100) <B>[DLL Issue]</B> Failed to enable DA logging channel*/
    ,S_FT_ERROR_END // END
    ...
    ,S_DL_SET_LONG_PRESS_PWKEY_FAILED = 5128 /*!<(5128) <B>[Target Issue]</B> Set Long Press Power Key failed due to BootROM write command failed*/
    ,S_DL_BINARY_AUTODECRYPT_NOT_SUPPORTED = 5129  /*!<(5129) */
    ,S_DL_CHIP_NOT_SUPPORT_TINY_SYSTEM = 5130 /*!<(5130) Download fail because target does not support tiny system*/
    ,S_DL_SET_LSRSTB_FAILED = 5131 /*!<(5131) Set LSRSTB failed due to BootROM write command failed */
    ,S_DL_PSRAM_INIT_FAILED = 5132 /*!<(5132) Initialize PSRAM failed due to BootROM write command failed */
	...
	//Error code from bootrom(7001~7099) (Do not modified the enum value)
	,S_SV5X_ERROR_BEGIN = 7001                                  /*!<security error code (7000~7999) */
	,S_SV5X_BROM_INCORRECT_PACKET_FORMAT = S_SV5X_ERROR_BEGIN   /*!<(7001) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_IMPOSSIBLE_DATA_LEN = 7002                     /*!<(7002) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_ONLY_PART_OF_DATA_WAS_WRITTEN = 7003           /*!<(7003) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_CMD_NOT_ALLOWED_IN_THE_CURRENT_STATE = 7004    /*!<(7004) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_VERIFICATION_FAIL = 7005                       /*!<(7005) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_MEM_REGION_NOT_ALLOWED_TO_BE_WRITTEN = 7006    /*!<(7006) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SBC_PUBK_HASH_INCONSISTENT_WITH_EFUSE = 7007   /*!<(7007) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_M1_INVALID_LEN = 7008                          /*!<(7008) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_M1_CMAC_NOT_MATCH = 7009                       /*!<(7009) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_TOOL_CERT_INVALID = 7010                       /*!<(7010) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_TOOL_CERT_ROOT_CERT_NOT_FOUND = 7011           /*!<(7011) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_TOOL_CERT_SBC_KEY_NOT_VALID_IN_ROOT_CERT = 7012     /*!<(7012) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_TOOL_CERT_SIG_DECRYPT_FAILED = 7013            /*!<(7013) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_TOOL_CERT_SIG_VERIFY_FAILED = 7014             /*!<(7014) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SLA_CHALLENGE_SLA_PUBK_DECRYPT_FAIL = 7015     /*!<(7015) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SLA_CHALLENGE_VERIFY_FAIL = 7016               /*!<(7016) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_DAA_SIG_DECRYPT_ERROR = 7017                   /*!<(7017) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_DAA_SIG_VERIFY_FAILED = 7018                   /*!<(7018) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_DAA_DA_INVALID = 7019                          /*!<(7019) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_DAA_HASH_INCONSISTENT_WITH_TOOL_CERT = 7020    /*!<(7020) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SCTRL_CERT_INVALID = 7021                      /*!<(7021) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SCTRL_CERT_ROOT_CERT_NOT_FOUND = 7022          /*!<(7022) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SCTRL_CERT_SBC_KEY_NOT_VALID_IN_ROOT_CERT = 7023     /*!<(7023) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SCTRL_CERT_ME_IDENTITY_NOT_MATCH = 7024        /*!<(7024) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SCTRL_CERT_SIG_DECRYPT_FAILED = 7025           /*!<(7025) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SCTRL_CERT_SIG_VERIFY_FAILED = 7026            /*!<(7026) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_ROOT_CERT_INVALID = 7027                       /*!<(7027) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_ROOT_CERT_SIG_DECRYPT_FAILED = 7028            /*!<(7028) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_ROOT_CERT_SIG_VERIFY_FAILED = 7029             /*!<(7029) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_UNEXPECTED_RETURN_FROM_CS = 7030               /*!<(7030) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_FLASH_NOT_EXIST = 7031                         /*!<(7031) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_SIZE_EXCEED_CMAC_VERIFY_UNIT = 7032            /*!<(7032) <B>[BROM Issue]</B> .*/
	,S_SV5X_BROM_DAA_DA_SIZE_INVALID = 7033                     /*!<(7033) <B>[BROM Issue]</B> .*/

	//Error code from api(7101~99)
	,S_SV5X_API_START = 7101
	,S_SV5X_API_SLA_KEY_FILE_NOT_EXIST = S_SV5X_API_START       /*!<(7101) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_SLA_KEY_FILE_OPEN_FAIL = 7102                   /*!<(7102) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_SLA_KEY_IS_ILLEGAL = 7103                       /*!<(7103) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_READ_ONLY_PARTIAL_DATA = 7104                   /*!<(7104) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_FAIL_TO_GET_CHIP_INFO = 7105                    /*!<(7105) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_LOAD_SLA_DLL_FAIL = 7106                        /*!<(7106) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_LOAD_SLA_DLL_LOAD_START_FAIL = 7107             /*!<(7107) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_SLA_CHALLENGE_START_FAIL = 7108                 /*!<(7108) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_LOAD_SLA_DLL_LOAD_END_FAIL = 7109               /*!<(7109) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_SLA_CHALLENGE_END_FAIL = 7110                   /*!<(7110) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_READ_EFUSE_FAIL = 7111                          /*!<(7111) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_DA_MAGIC_INVALID = 7112                         /*!<(7112) <B>[BROM Issue]</B> .*/
	,S_SV5X_API_DA_SIZE_INVALID = 7113                          /*!<(7113) <B>[BROM Issue]</B> .*/
    ,S_SV5X_ERROR_END // END
