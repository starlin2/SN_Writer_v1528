...
// MTK_INTERNAL
#ifdef __TC01__
    // [Tier01-CreateEntries]
    extern int __stdcall DL_Rom_Create(DL_HANDLE_T dl_handle, const char *name, unsigned int load_addr, _BOOL is_offset, unsigned short *index);
#endif
// End Of MTK_INTERNAL
...
#ifdef __TC01__
    // [Tier01-LoadFS]
    extern int __stdcall DL_FS_GetCount(DL_HANDLE_T dl_handle, unsigned short *p_fs_count);
    extern int __stdcall DL_FS_GetInfo(DL_HANDLE_T dl_handle, unsigned short index, FS_INFO *p_fs_info);

    // [Tier01-CreateEntries]
    extern int __stdcall DL_FS_Create(DL_HANDLE_T dl_handle, const char *name, unsigned short *index);

    extern int __stdcall DL_FS_Load(DL_HANDLE_T dl_handle, unsigned short index, const char *filepath);
    // [Tier01-LoadFromBuffer]
    extern int __stdcall DL_FS_LoadBuf(DL_HANDLE_T dl_handle, unsigned short index, const unsigned char *buf, unsigned int buf_len);
    extern int __stdcall DL_FS_Unload(DL_HANDLE_T dl_handle, unsigned short index);
    extern int __stdcall DL_FS_UnloadAll(DL_HANDLE_T dl_handle);
    extern int __stdcall DL_FS_SetEnableAttr(DL_HANDLE_T dl_handle, unsigned short index, _BOOL attr);
#endif
// End Of MTK_INTERNAL
