...
void CAutoGenDlg::UpdateUIComponent()
{
    ...
    {
        ((CButton *)GetDlgItem(IDC_DENARY_INCREASE))->SetCheck(TRUE);//ักษฯ
    } 
    else
    {
        ((CButton *)GetDlgItem(IDC_HEX_INCREASE))->SetCheck(TRUE);//ัก
    }
...
{
    UpdateData(TRUE);
    g_AutoGenData.bAutoGenBarcode = m_bAutoGenBarc;
    g_AutoGenData.bAutoGenIMEI = m_bAutoGenIMEI;
    g_AutoGenData.bAutoGenBT = m_bAutoGenBT;
    g_AutoGenData.bAutoGenWifi = m_bAutoGenWifi;
    g_AutoGenData.bAutoGenEthernet = m_bAutoGenEthernet;
    g_AutoGenData.bAutoGenDRMKeyMCID = m_bAutoGenDRMKeyMCID;
