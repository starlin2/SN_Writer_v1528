...
void CSystemConfig::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_WRITE_WIFIEPP_CHECK, m_bWifiEppCopy);
...
BEGIN_MESSAGE_MAP(CSystemConfig, CDialog)
	...
	ON_BN_CLICKED(IDC_WRITE_WIFIEPP_CHECK, OnWriteWifieppCheck)
...
BOOL CSystemConfig::OnInitDialog() 
{
	...
	if(false == g_sMetaComm.EnableSerialNo)
	{
	...
	{
		GetDlgItem(IDC_WRITE_MEID_CHECK)->ShowWindow(false);
		GetDlgItem(IDC_WRITE_ESN_CHECK)->ShowWindow(false);
...
void CSystemConfig::OnBarcHeaderCheck() 
{
    ...
    UpdateData(TRUE);
    g_sMetaComm.sBarcHeader_Option.bCheckHeader = m_bCheckBarcHD;
...
void CSystemConfig::OnBtHeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sBTHeader_Option.bCheckHeader = m_bCheckBTHD;
...
void CSystemConfig::OnWifiHeaderCheck() 
{
    // TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWifiHeader_Option.bCheckHeader = m_bCheckWifiHD;
...
void CSystemConfig::OnDualImei() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.bDualIMEI = m_bDualIMEI;
    if(m_bDualIMEI)
    {
        g_sMetaComm.sIMEIOption.iImeiNums  = DUAL_IMEI;
        g_sMetaComm.sIMEIOption.bDualIMEI  = true;
...
void CSystemConfig::OnDualImeiSame() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.bDualIMEISame = m_bDualIMEISame;
...
void CSystemConfig::OnFourImei() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.bFourIMEI = m_bFourIMEI;
...
void CSystemConfig::OnImei1HeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIHeader_Option[0].bCheckHeader = m_bCheckIMEI_1_HD;
...
void CSystemConfig::OnImei2HeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIHeader_Option[1].bCheckHeader = m_bCheckIMEI_2_HD;
    ((CWnd*)GetDlgItem(IDC_IMEI_2_HEADER_STR))->EnableWindow(m_bCheckIMEI_2_HD);
}
...
void CSystemConfig::OnImei3HeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIHeader_Option[2].bCheckHeader = m_bCheckIMEI_3_HD;
...
void CSystemConfig::OnImei4HeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIHeader_Option[3].bCheckHeader = m_bCheckIMEI_4_HD;
...
void CSystemConfig::OnImeiChecksum() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.bCheckSum = m_bIMEICheckSum; 
}
...
void CSystemConfig::OnImeiLock() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.bLockIMEI = m_bIMEILock; 
}
...
void CSystemConfig::OnThreeImei() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.bThreeIMEI = m_bThreeIMEI;
...
void CSystemConfig::OnWriteBarcCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteBarcode = m_bWriteBarc;
...
void CSystemConfig::OnWriteBtCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteBT = m_bWriteBTAddr;
...
void CSystemConfig::OnWriteImeiCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteIMEI = m_bWriteIMEI;
...
void CSystemConfig::OnWriteWifiCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteWifi = m_bWriteWifi;
    ((CWnd*)GetDlgItem(IDC_WIFI_HEADER_CHECK))->EnableWindow(m_bWriteWifi);    
    if (m_bWriteWifi)
    {
        g_sMetaComm.sWriteOption.bWifiEPPCopy = false;
        ((CWnd*)GetDlgItem(IDC_WIFI_HEADER_STR))->EnableWindow(m_bCheckWifiHD);
        ((CWnd*)GetDlgItem(IDC_WRITE_WIFIEPP_CHECK))->EnableWindow(FALSE);
    }
    else
    {
        ((CWnd*)GetDlgItem(IDC_WRITE_WIFIEPP_CHECK))->EnableWindow(TRUE);
        ((CWnd*)GetDlgItem(IDC_WIFI_HEADER_STR))->EnableWindow(FALSE);
    }
}

void CSystemConfig::OnWriteWifieppCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWifiEPPCopy = m_bWifiEppCopy;
    ((CWnd*)GetDlgItem(IDC_WRITE_WIFI_CHECK))->EnableWindow(FALSE);
    if(m_bWifiEppCopy)
    {
    ...
    {
        ((CWnd*)GetDlgItem(IDC_WRITE_WIFI_CHECK))->EnableWindow(TRUE);
    }
}
#if 0
...
void CSystemConfig::UpdateConfigUIOption()
{
    ...
    m_bWifiEppCopy   = g_sMetaComm.sWriteOption.bWifiEPPCopy;
...
void CSystemConfig::OnCurrentTemperature() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
    g_sMetaComm.sIMEIOption.Temp_Option.bWriteTemperature = m_bWriteTemperature;
...
void CSystemConfig::OnWriteEthernetMacCheck() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteEthernetMac =  m_bWriteEthernetMac;
...
void CSystemConfig::OnEthernetHeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sEthernetMacHeader_Option.bCheckHeader = m_bCheckEthernetHD;
    ((CWnd*)GetDlgItem(IDC_ETHERNET_HEADER_STR))->EnableWindow(m_bCheckEthernetHD);
}
...
void CSystemConfig::OnWriteDrmkeyMcidCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteDrmkeyMCID =  m_bWriteDrmkeyMCID;
...
void CSystemConfig::OnDrmkeyMcidHeaderCheck() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sDrmkeyMCIDHeader_Option.bCheckHeader = m_bCheckDrmkeyMCID_HD;
    ((CWnd*)GetDlgItem(IDC_DRMKEY_MCID_HEADER_STR))->EnableWindow(m_bCheckDrmkeyMCID_HD);
}
...
void CSystemConfig::OnWriteSerialNoCheck() 
{
    // TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteSerialNo =  m_bWriteSerialNo;
    
    ((CWnd*)GetDlgItem(IDC_SERIAL_NO_HEADER_CHECK))->EnableWindow(m_bWriteSerialNo);   
    if (m_bWriteSerialNo)
    {
    ...
    {
        ((CWnd*)GetDlgItem(IDC_SERIAL_NO_HEADER_STR))->EnableWindow(FALSE);
    }
}
...
void CSystemConfig::OnSerialNoHeaderCheck() 
{
    // TODO: Add your control notification handler code here
    UpdateData(TRUE);
    g_sMetaComm.sSerialNoHeader_Option.bCheckHeader = m_bCheckSerialNoHD;
    ((CWnd*)GetDlgItem(IDC_SERIAL_NO_HEADER_STR))->EnableWindow(m_bCheckSerialNoHD);
}
...
void CSystemConfig::OnWriteMeidCheck() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteMeid = m_bWriteMeid;
...
void CSystemConfig::OnMeidHeaderCheck() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
    g_sMetaComm.sMeidHeader_Option.bCheckHeader = m_bCheckMeidHD;
    ((CWnd*)GetDlgItem(IDC_MEID_HEADER_STR))->EnableWindow(m_bCheckMeidHD);
...
void CSystemConfig::OnEsnHeaderCheck() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
    g_sMetaComm.sEsnHeader_Option.bCheckHeader = m_bCheckEsnHD;
...
void CSystemConfig::OnWriteEsnCheck() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
    g_sMetaComm.sWriteOption.bWriteEsn = m_bWriteEsn;
